...
from core_logic.htr_word.preprocess.language.jpn.yolov5.utils.datasets import exif_transpose, letterbox
from core_logic.htr_word.preprocess.language.jpn.yolov5.utils.general import (LOGGER, check_requirements, check_suffix, colorstr, increment_path, make_divisible,
...
class DetectMultiBackend(nn.Module):
    ...
    def __init__(self, weights='yolov5s.pt', device=None, dnn=True):
        ...
        from core_logic.htr_word.preprocess.language.jpn.yolov5.models.experimental import attempt_load  
