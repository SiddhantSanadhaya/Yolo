...
def japanese_single_char_preprocess(np_data,th):
    ...
    try:
        ...
        index_bracket= np.where(detections["detection_classes"]==1)[1]
        ...
        np_data_1 = image_copy
        
        Sp_char_position_list = []
        
            
             
        print(detections["detection_scores"][0][index_printed[0]],th)
        if detections["detection_scores"][0][index_printed[0]] >= th:
        ...
        #if detections["detection_scores"][0][index_bracket[0]] >= th:
            #start_x_printed=int(detections["detection_boxes"][0][index_bracket[0]][1]*np_data_1.shape[1])
            #start_y_printed=int(detections["detection_boxes"][0][index_bracket[0]][0]*np_data_1.shape[0])
            #end_x_printed=int(detections["detection_boxes"][0][index_bracket[0]][3]*np_data_1.shape[1])
            #end_y_printed=int(detections["detection_boxes"][0][index_bracket[0]][2]*np_data_1.shape[0])

            #cv2.rectangle(image_copy,(start_x_printed,start_y_printed),(end_x_printed,end_y_printed),(255,255,255),-1)


        Htr_logger.log(Htr_logger.info,"japanese_od : japanese_single_char_preprocess : complete")
        #print(detections["detection_scores"][0][index_printed[0]])
