...
def check_small(text,height,area,flag):
    ...
    # print(key,"in check small function")
    # if key!=len(text):
    #     max_height=sorted(height,reverse=True)[key]
    # else:
        ...
        for j in range(len(filter_word)):
            if filter_word[j][0] == sent[i]:
                if i==0:
                    ...
                    # print(bef)
                    # mid1 = filter_word[j][2] is None or (i>0 and sent[i-1] in filter_word[j][2])
                    # print(mid1)
