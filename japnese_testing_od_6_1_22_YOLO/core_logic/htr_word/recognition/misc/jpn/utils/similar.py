...
[ 
  ...
  ('ぉ', 'お', small, kanji),
  ('っ', 'つ', small, kanji),
  ('ブ','づ',katakana,hiragana),
('づ','ブ',hiragana,katakana),
...
('カ','か',katakana,hiragana),
('か','カ',hiragana,katakana),
('ガ','が',katakana,hiragana),
('が','ガ',hiragana,katakana)
]
                ...
                if i==0 or i==len(sent)-1:
                    ...
                    if sent[i-1] in special:
                        ...
                        if aft and bef:
                            ...
                            if dict1["k"]>dict1["h"]:
                                if sent[i] ==  filter_word[j][0] and hiragana==filter_word[j][2]:
                                    sent[i] = filter_word[j][1]
                                
                            elif dict1["h"]>dict1["k"]:
                                if sent[i] ==  filter_word[j][0] and katakana==filter_word[j][2]:
                                    sent[i] = filter_word[j][1]
